...
# desk-sim -m examples/3.py --mode visualization
# desk-sim -m examples/3.py --mode single
# desk-sim -m examples/3.py --mode replications
# desk-sim -m examples/3.py --mode factorial
