...
def operacao(env, nome, operador_A, operador_B, operador_C):
    ...
    if sorteio <= 0.75: # A máquina vai para a manutenção em A
        estacao='A'        
        env.process(manutencao_A(env, nome, estacao, operador_A, operador_B, operador_C))
    else:
        estacao='B'        
        env.process(manutencao_B(env, nome, estacao, operador_A, operador_B, operador_C))


def manutencao_A(env, nome, estacao, operador_A, operador_B, operador_C):
    ...
    # chama o proximo "bloco"
    env.process(inspecao(env, nome, estacao, operador_A, operador_B, operador_C))


def manutencao_B(env, nome, estacao, operador_A, operador_B, operador_C):
    momento_entrada_fila[nome] = env.now            
    # Seize, Delay, Release
...
def inspecao(env, nome, estacao, operador_A, operador_B, operador_C):
    momento_entrada_fila[nome] = env.now            
    # Seize, Delay, Release
