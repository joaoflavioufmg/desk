...
# desk-sim -m examples/1.py --mode visualization
# desk-sim -m examples/1.py --mode single
# desk-sim -m examples/1.py --mode replications
# desk-sim -m examples/1.py --mode factorial
