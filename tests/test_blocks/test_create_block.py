...
class TestCreateBlock:
    ...
    def test_create_with_priority_generator(self):
    ...
    def test_entity_generation_count(self):
        ...
        assert block.entities_created == 5
    
    def test_entity_generation_with_first_creation_delay(self):
    ...
    def test_process_entity_raises_error(self):
